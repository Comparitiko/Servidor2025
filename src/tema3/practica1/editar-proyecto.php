      ...
      if (is_null($proyecto)) {
        ...
        <form method="post" action="controlador.php" name="editar-proyecto">
          ...
          <div class="form-group">
            ...
            <input type="date" class="form-control" id="fecha-inicio" name="fecha-inicio" value="<?php echo $proyecto["fecha_inicio"]; ?>" required>
          </div>
          <div class="form-group">
            <label for="fecha-fin" class="form-label">Fecha fin</label>
            <input type="date" class="form-control" id="fecha-fin" name="fecha-fin" value="<?php echo $proyecto["fecha_fin_prevista"]; ?>" required>
          </div>
          <div class="form-group">
            <label for="porcentaje-completado" class="form-label">Porcentaje completado</label>
            <input type="number" class="form-control" id="porcentaje-completado" name="porcentaje-completado" value="<?php echo $proyecto["porcentaje_completado"]; ?>" required min="0" max="100">
          </div>
          <div class="form-group">
            <label for="importancia" class="form-label">Importancia</label>
            <input type="number" class="form-control" id="importancia" name="importancia" value="<?php echo $proyecto["importancia"]; ?>" required min="1" max="5">
